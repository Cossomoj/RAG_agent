...
function formatAnswerText(text) {
    ...
    // Используем исходный текст напрямую (убираем вызов несуществующей функции)
    const processedText = text;
    console.log('🔧 Текст для обработки (первые 200 символов):', processedText.substring(0, 200) + '...');
