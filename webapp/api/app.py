...
QUESTIONS_BY_ROLE = {
    "PO/PM": [
        {
            "id": "15",
            "title": "Что я могу ожидать от специалиста Аналитика",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы со специалистами-аналитиками",
            "text": "Что я могу ожидать от специалиста Аналитика"
        },
        {
            "id": "25",
            "title": "Что я могу ожидать от специалиста Тестировщика",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы со специалистами-тестировщиками",
            "text": "Что я могу ожидать от специалиста Тестировщика"
        },
        {
            "id": "26",
            "title": "Что я могу ожидать от специалиста WEB",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы со специалистами WEB-разработки",
            "text": "Что я могу ожидать от специалиста WEB"
        },
        {
            "id": "27",
            "title": "Что я могу ожидать от специалиста Java",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы со специалистами Java-разработки",
            "text": "Что я могу ожидать от специалиста Java"
        },
        {
            "id": "28",
            "title": "Что я могу ожидать от специалиста Python",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы со специалистами Python-разработки",
            "text": "Что я могу ожидать от специалиста Python"
        },
        {
            "id": "16",
            "title": "Что я могу ожидать от лида компетенции Аналитика",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы с лидами-аналитиками",
            "text": "Что я могу ожидать от лида компетенции Аналитика"
        },
        {
            "id": "29",
            "title": "Что я могу ожидать от лида компетенции Тестировщика",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы с лидами-тестировщиками",
            "text": "Что я могу ожидать от лида компетенции Тестировщика"
        },
        {
            "id": "30",
            "title": "Что я могу ожидать от лида компетенции WEB",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы с лидами WEB-разработки",
            "text": "Что я могу ожидать от лида компетенции WEB"
        },
        {
            "id": "31",
            "title": "Что я могу ожидать от лида компетенции Java",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы с лидами Java-разработки",
            "text": "Что я могу ожидать от лида компетенции Java"
        },
        {
            "id": "32",
            "title": "Что я могу ожидать от лида компетенции Python",
            "category": "Взаимодействие",
            "preview": "Ожидания от работы с лидами Python-разработки",
            "text": "Что я могу ожидать от лида компетенции Python"
        },
        {
            "id": "17",
        ...
        },
        {
            ...
            "preview": "Лучшие практики работы",
        ...
        },
        {
            ...
            "category": "Управление",
            "preview": "Эффективное управление временем",
...
def get_questions():
    ...
    try:
        ...
        if not role:
            ...
            for role_name, questions in QUESTIONS_BY_ROLE.items():
                if isinstance(questions, dict):
                    # Для ролей со специализацией выбираем подходящую специализацию
                    if specialization in questions:
                        all_questions.extend(questions[specialization])
                    elif "default" in questions:
                        all_questions.extend(questions["default"])
                    else:
                        # Если нет подходящей специализации, берем первую доступную
                        first_spec = next(iter(questions.values()))
                        if isinstance(first_spec, list):
                            all_questions.extend(first_spec)
        ...
        if role in QUESTIONS_BY_ROLE:
            ...
            if isinstance(questions, dict):
                # Для ролей со специализацией (Лид, Специалист, Стажер)
                if specialization in questions:
                    ...
                    first_spec = next(iter(questions.values()))
                    if isinstance(first_spec, list):
                        return jsonify(first_spec)
            elif isinstance(questions, list): # Для PO/PM
